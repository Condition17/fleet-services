...
var file_file_service_proto_rawDesc = []byte{
	...
	0x65, 0x64, 0x43, 0x68, 0x75, 0x6e, 0x6b, 0x73, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x32, 0x92, 0x02,
...
var file_file_service_proto_depIdxs = []int32{
	...
	4, // 4: go.micro.api.fileservice.FileService.CreateChunk:output_type -> go.micro.api.fileservice.EmptyResponse
	5, // 5: go.micro.api.fileservice.FileService.CreateFile:output_type -> go.micro.api.fileservice.Response
	5, // 6: go.micro.api.fileservice.FileService.ReadFile:output_type -> go.micro.api.fileservice.Response
