...
func (c *fileServiceClient) CreateChunk(ctx context.Context, in *ChunkSpec, opts ...grpc.CallOption) (*EmptyResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/go.micro.api.file_service.FileService/CreateChunk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) CreateFile(ctx context.Context, in *File, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/go.micro.api.file_service.FileService/CreateFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) ReadFile(ctx context.Context, in *File, opts ...grpc.CallOption) (*Response, error) {
	out := new(Response)
	err := c.cc.Invoke(ctx, "/go.micro.api.file_service.FileService/ReadFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *fileServiceClient) GetChunkDetailsByIndexInFile(ctx context.Context, in *ChunkSpec, opts ...grpc.CallOption) (*ChunkDetails, error) {
	...
	err := c.cc.Invoke(ctx, "/go.micro.api.file_service.FileService/GetChunkDetailsByIndexInFile", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _FileService_CreateChunk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.micro.api.file_service.FileService/CreateChunk",
	}
...
func _FileService_CreateFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.micro.api.file_service.FileService/CreateFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FileService_ReadFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.micro.api.file_service.FileService/ReadFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _FileService_GetChunkDetailsByIndexInFile_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/go.micro.api.file_service.FileService/GetChunkDetailsByIndexInFile",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _FileService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "go.micro.api.file_service.FileService",
