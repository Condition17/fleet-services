...
require (
	...
	github.com/Condition17/fleet-services/run-controller-service v0.0.0-20201114193928-f881acfb0b4f
	github.com/Condition17/fleet-services/test-run-service v0.0.0-20201114193928-f881acfb0b4f
	github.com/Condition17/fleet-services/user-service v0.0.0-20201114193928-f881acfb0b4f
