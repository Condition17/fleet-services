...
var file_proto_test_run_service_test_run_service_proto_rawDesc = []byte{
	...
	0x73, 0x74, 0x52, 0x75, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x22, 0x56, 0x0a, 0x14,
	0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x54, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x52, 0x65, 0x71,
	0x75, 0x65, 0x73, 0x74, 0x12, 0x3e, 0x0a, 0x07, 0x74, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x18,
	...
	0x69, 0x63, 0x65, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x52, 0x07, 0x74, 0x65, 0x73,
	0x74, 0x52, 0x75, 0x6e, 0x22, 0x5a, 0x0a, 0x04, 0x55, 0x73, 0x65, 0x72, 0x12, 0x0e, 0x0a, 0x02,
	...
	0x22, 0xb8, 0x01, 0x0a, 0x07, 0x54, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x12, 0x0e, 0x0a, 0x02,
	0x69, 0x64, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0d, 0x52, 0x02, 0x69, 0x64, 0x12, 0x12, 0x0a, 0x04,
	0x6e, 0x61, 0x6d, 0x65, 0x18, 0x02, 0x20, 0x01, 0x28, 0x09, 0x52, 0x04, 0x6e, 0x61, 0x6d, 0x65,
	0x12, 0x16, 0x0a, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x18, 0x04, 0x20, 0x01, 0x28, 0x0d,
	0x52, 0x06, 0x75, 0x73, 0x65, 0x72, 0x49, 0x64, 0x12, 0x35, 0x0a, 0x04, 0x75, 0x73, 0x65, 0x72,
	0x18, 0x05, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x21, 0x2e, 0x67, 0x6f, 0x2e, 0x6d, 0x69, 0x63, 0x72,
	...
	0x73, 0x74, 0x61, 0x74, 0x65, 0x12, 0x24, 0x0a, 0x0d, 0x73, 0x74, 0x61, 0x74, 0x65, 0x4d, 0x65,
	0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x18, 0x07, 0x20, 0x01, 0x28, 0x09, 0x52, 0x0d, 0x73, 0x74,
	0x61, 0x74, 0x65, 0x4d, 0x65, 0x74, 0x61, 0x64, 0x61, 0x74, 0x61, 0x22, 0x50, 0x0a, 0x0e, 0x54,
	...
	0x0d, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x32, 0xda,
	0x04, 0x0a, 0x0e, 0x54, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63,
	...
	0x65, 0x2e, 0x54, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x22, 0x00, 0x62, 0x06, 0x70, 0x72, 0x6f,
	0x74, 0x6f, 0x33,
}
...
var file_proto_test_run_service_test_run_service_proto_goTypes = []interface{}{
	...
	(*User)(nil),                 // 1: go.micro.api.testRunService.User
	(*TestRun)(nil),              // 2: go.micro.api.testRunService.TestRun
	(*TestRunDetails)(nil),       // 3: go.micro.api.testRunService.TestRunDetails
	(*ListResponse)(nil),         // 4: go.micro.api.testRunService.ListResponse
	(*TestRunStateSpec)(nil),     // 5: go.micro.api.testRunService.TestRunStateSpec
	(*EmptyRequest)(nil),         // 6: go.micro.api.testRunService.EmptyRequest
	(*EmptyResponse)(nil),        // 7: go.micro.api.testRunService.EmptyResponse
}
var file_proto_test_run_service_test_run_service_proto_depIdxs = []int32{
	2,  // 0: go.micro.api.testRunService.CreateTestRunRequest.testRun:type_name -> go.micro.api.testRunService.TestRun
	1,  // 1: go.micro.api.testRunService.TestRun.user:type_name -> go.micro.api.testRunService.User
	2,  // 2: go.micro.api.testRunService.TestRunDetails.testRun:type_name -> go.micro.api.testRunService.TestRun
	2,  // 3: go.micro.api.testRunService.ListResponse.testRuns:type_name -> go.micro.api.testRunService.TestRun
	0,  // 4: go.micro.api.testRunService.TestRunService.Create:input_type -> go.micro.api.testRunService.CreateTestRunRequest
	2,  // 5: go.micro.api.testRunService.TestRunService.Get:input_type -> go.micro.api.testRunService.TestRun
	2,  // 6: go.micro.api.testRunService.TestRunService.GetById:input_type -> go.micro.api.testRunService.TestRun
	6,  // 7: go.micro.api.testRunService.TestRunService.List:input_type -> go.micro.api.testRunService.EmptyRequest
	2,  // 8: go.micro.api.testRunService.TestRunService.Delete:input_type -> go.micro.api.testRunService.TestRun
	5,  // 9: go.micro.api.testRunService.TestRunService.ChangeState:input_type -> go.micro.api.testRunService.TestRunStateSpec
	3,  // 10: go.micro.api.testRunService.TestRunService.Create:output_type -> go.micro.api.testRunService.TestRunDetails
	3,  // 11: go.micro.api.testRunService.TestRunService.Get:output_type -> go.micro.api.testRunService.TestRunDetails
	3,  // 12: go.micro.api.testRunService.TestRunService.GetById:output_type -> go.micro.api.testRunService.TestRunDetails
	4,  // 13: go.micro.api.testRunService.TestRunService.List:output_type -> go.micro.api.testRunService.ListResponse
	7,  // 14: go.micro.api.testRunService.TestRunService.Delete:output_type -> go.micro.api.testRunService.EmptyResponse
	2,  // 15: go.micro.api.testRunService.TestRunService.ChangeState:output_type -> go.micro.api.testRunService.TestRun
