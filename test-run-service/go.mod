...
require (
	...
	github.com/Condition17/fleet-services/run-controller-service v0.0.0-20201107200319-06e7c1fec256
	github.com/Condition17/fleet-services/user-service v0.0.0-20201107200319-06e7c1fec256
