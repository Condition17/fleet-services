...
type FileSpec struct {
	...
	TestRunId    string `protobuf:"bytes,2,opt,name=testRunId,proto3" json:"testRunId,omitempty"`
...
func (x *FileSpec) GetTestRunId() string {
	if x != nil {
		return x.TestRunId
	}
	return ""
...
var file_proto_run_controller_service_run_controller_service_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x09, 0x74, 0x65, 0x73, 0x74, 0x52, 0x75, 0x6e, 0x49, 0x64, 0x12, 0x12,
