...
require (
	github.com/Condition17/fleet-services/file-builder v0.0.0-20201129203036-3e4b08765fd8
	...
	github.com/Condition17/fleet-services/user-service v0.0.0-20201129203036-3e4b08765fd8 // indirect
